...
from .views import ItensViewSet, ItemListView, MyItemListView, ItemCreateView, AlternativaCreateView,AlternativasViewSet, sucess_create
...
urlpatterns = [
    ...
    path('success', sucess_create, name='sucess_form_create'),
